...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    public void no_subscription_no_gains() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doOnSubscribe(consumer -> hooksTriggered.add("subscribe"))
    ...
    public void be_there_early() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doOnRequest(consumer -> hooksTriggered.add(0, "before subscribe"))
                //todo: change this line only
                ;
    ...
    public void one_to_catch_them_all() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doFinally(consumer -> hooksTriggeredCounter.incrementAndGet())
                //todo: change this line only
                ;
...
//        just.subscribe(subscriber -> subscriber.);//todo: change this line only
